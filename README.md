...
* Add to your Gemfile: `gem 'rails_emoji', '~> 1.5'`, then: `$ bundle`.

* Or, download the [rails_emoji-1.5.gem](https://rubygems.org/downloads/rails_emoji-1.5.gem), then `$ gem install ./rails_emoji-1.5.gem --no-ri --no-rdoc`.
